...
public class AuthController {
    ...
    public ResponseEntity<Map<String, Object>> register(@Valid @RequestBody User user) {
        ...
        try {
            ...
            logger.info("Iniciando envio de código de verificação para: {}", savedUser.getEmail());
            try {
                VerificationCode verificationCode = emailService.createVerificationCode(savedUser.getEmail());
                logger.info("Código de verificação criado: {} para email: {}", verificationCode.getCode(), savedUser.getEmail());
                emailSent = emailService.sendVerificationEmail(savedUser.getEmail(), verificationCode.getCode());
                logger.info("Email de verificação enviado com sucesso: {} para email: {}", emailSent, savedUser.getEmail());
            } catch (Exception e) {
